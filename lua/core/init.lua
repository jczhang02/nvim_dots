...
local create_asyncrun_command = function()
	vim.cmd([[command Runtmux AsyncRun -mode=term -pos=tmux python -u %]])
	vim.cmd([[command Rungnome AsyncRun -mode=term -pos=gnome python -u %]])
end
